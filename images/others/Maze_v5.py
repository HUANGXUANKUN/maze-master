...
def nextStage(isNextStage):
    ...
    if isNextStage:
        ...
        if current_level == 5:
            ...
            gameOverWindow = leaderboard.gameOverWindow("CONGRATULATIONS YOU WON !", win_width,
...
#fading
    ...
    while running:
        ...
        #gameOverWindow = GameOverWindow(1024,768,FONT, "highscore.txt", 200, 4)
            ...
            #print(__file__)
            gameOverWindow = leaderboard.GameOverWindow("GAME OVER", win_width, win_height, FONT, "highscore.txt", player.score, current_level + 1)
